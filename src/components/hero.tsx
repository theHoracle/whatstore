...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-[calc(100lvh-50px)] overflow-hidden border-b bg-background py-20 sm:py-32">
        ...
        <div className="flex flex-col items-center gap-8 text-center">
          <div className="space-y-4 max-w-[800px]">
            ...
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text text-transparent">
              Your Dream Store, Made Real
            </h1>
            <p className="mx-auto max-w-[700px] text-muted-foreground text-lg md:text-xl">
              Create your online store and start selling anything - from physical products to digital goods and services. Join thousands of successful sellers on WhatStore.
            </p>
          </div>
